...
import 'package:iritin/providers/dashboard_provider.dart'; // Pastikan ini diimport
...
// --- WARNA & KONSTANTA (SAMAKAN DENGAN HOMESCREEN) ---
const Color primaryGreen = Color(0xFFD1F333); // Hijau Lime (Warna Utama)
const Color accentGreen = Color(0xFFF2FFB0);
const Color textColor = Color(0xFF2E4053);
const Color darkGreen = Color(0xFF558B2F); // Hijau Tua untuk Teks/Ikon aktif
...
class _HistoryScreenState extends State<HistoryScreen> {
        ...
        return Theme(
          data: ThemeData.light().copyWith(
            colorScheme: const ColorScheme.light(
              primary: darkGreen, // Hijau Tua Iritin
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // 1. HEADER (WARNA SUDAH DIPERBAIKI: primaryGreen)
          Container(
            color: primaryGreen, // <--- INI KUNCINYA (0xFFD1F333)
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white.withOpacity(
                          0.5,
                        ), // Putih transparan biar nyatu sama hijau
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          // Indikator jika filter tanggal aktif
                          if (_selectedDateRange != null)
                            Container(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 8,
                  ...
                  child: currentList.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            final item =
                                currentList[currentList.length - 1 - index];
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFF5F6FA), // Abu-abu muda clean
  ...
  Widget _buildTransactionItem(Map<String, dynamic> item) {
    ...
    return GestureDetector(
      onTap: () {
        // --- FIX DI SINI: Gunakan DashboardProvider untuk navigasi ---
